...
<html>
  ...
  <title>Plant page</title>
    ...
    <style>
      ...
      .cards {max-width: 500px; margin: 0 auto; display: grid; grid-gap: 10px; grid-template-columns: repeat(auto-fit, minmax(245px, 1fr));}
      .cards1 {max-width: 500px; margin: 0 auto; display: grid; grid-gap: 10px; grid-template-columns: repeat(auto-fit, minmax(245px, 1fr));}
...
$user=mysqli_fetch_array($results);
  ...
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <li class="w3-padding-14">
      <h2 style="color: white;" class="w3-wide"> <?php echo $plant; ?> </h2>
